        ...
        <>
            <div className="bg-bgChatBlue dark:bg-bgChatBlueDark flex-col lg:w-9/12 w-full px-3 py-2 flex min-h-[75vh] max-h-[75vh] rounded-md md:max-w-4xl items-center">
                ...
                <div className="self-end w-full flex-row flex gap-2 mt-auto items-center justify-center">
                    ...
                    <textarea id="messageTextarea" className="mt-2 w-4/5 md:w-full rounded-md focus:outline-none focus:ring-2 focus:ring-blueLight dark:focus:ring-blueLightDark p-1 text-fontText resize-none dark:bg-cardDark" value={message} onChange={(e)=>{setMes(e.target.value)}}></textarea>
