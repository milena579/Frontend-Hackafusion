...
export const ChatPublico = ({user, message} : IChatPublico) => {
    ...
    return(
        <>
            <div className="flex flex-col gap-2 p-4 max-h-[70%] min-h-[70%] w-[70%]  bottom-0 left-0  bg-bgChatBlue rounded-lg justify-between dark:bg-backgroundCardBlueDark dark:text-fontTextDark">
                ...
                <div className="flex flex-ro gap-4 items-center p-4  bottom-24 w-[100%] ">
                    <textarea  className="w-full p-1 flex  flex-col flex-wrap dark:bg-bgInputDark max-h-40 rounded" />
