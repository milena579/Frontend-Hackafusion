                ...
                {isOpen && (
                    <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex flex-col items-center justify-center gap-4">
                        ...
                        <div className="flex gap-5">
                            <button onClick={modalNotification}>
                                <svg className="w-10 text-fontTitleDark" viewBox="-0.96 -0.96 25.92 25.92" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M18.7491 9.70957V9.00497C18.7491 5.13623 15.7274 2 12 2C8.27256 2 5.25087 5.13623 5.25087 9.00497V9.70957C5.25087 10.5552 5.00972 11.3818 4.5578 12.0854L3.45036 13.8095C2.43882 15.3843 3.21105 17.5249 4.97036 18.0229C9.57274 19.3257 14.4273 19.3257 19.0296 18.0229C20.789 17.5249 21.5612 15.3843 20.5496 13.8095L19.4422 12.0854C18.9903 11.3818 18.7491 10.5552 18.7491 9.70957Z" stroke="currentColor" strokeWidth="2.304"></path> <path d="M7.5 19C8.15503 20.7478 9.92246 22 12 22C14.0775 22 15.845 20.7478 16.5 19" stroke="currentColor" strokeWidth="2.304" strokeLinecap="round"></path> </g></svg>
                            </button>
                            <button onClick={modalSearch}>
                                <svg
                                    className="w-9 text-fontTitleDark"
                                    version="1.1"
                                    id="_x32_"
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlnsXlink="http://www.w3.org/1999/xlink"
                            ...
                            <Link href={ROUTES.login} onClick={toggleMenu} className="flex items-center gap-2">
                                <svg
                                    className="w-8 text-fontTitleDark"
                                    viewBox="0 0 600 600"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="currentColor" 
                                    >
