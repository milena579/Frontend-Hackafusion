        ...
        <>
            <div className="bg-bgChatBlue dark:bg-bgChatBlueDark flex-col w-full px-3 py-2 flex h-80 rounded-md md:max-w-4xl items-center">
                ...
                <div className="self-end w-full flex-row flex gap-1 mt-auto items-center justify-center">
                    ...
                    <textarea id="messageTextarea" className="mt-2 w-full rounded-md focus:outline-none focus:ring-2 focus:ring-blueLight dark:focus:ring-blueLightDark p-1 text-fontText resize-none dark:bg-cardDark"></textarea>
