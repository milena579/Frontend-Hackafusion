    ...
    return (
        <>
            <div className='fixed inset-0 w-screen h-screen bg-black bg-opacity-75 z-50 flex flex-col items-center justify-center gap-4'>
                <div className='flex flex-col fixed bg-background md:w-3/6 md:min-h-80 w-11/12 h-5/6 p-3 rounded-lg shadow'>
                    <div className='flex flex-row items-center w-full justify-between'>
                        <h1 className='text-fontText text-xl font-semibold mb-2'>{title}</h1>
