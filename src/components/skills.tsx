        ...
        <>
            {button ? (
                <button onClick={button}>
                    <div className={`bg-${cor} dark:bg-${cor}Dark min-w-24 flex items-center justify-center rounded-md px-3 py-1 hover:bg-${cor}Hover dark:hover:bg-${cor}DarkHover transition-colors duration-300`}>
