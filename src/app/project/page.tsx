        ...
        <>
            ...
            <div className="flex px-16 items-center flex-col gap-4">
                <div className="flex items-center w-8/12 py-8 px-14 justify-center ">
                    ...
                    <input className="w-full flex border-b-2 focus:outline-none p-2 dark:text-fontTextDark dark:bg-backgroundDark" placeholder="Digite a projeto que deseja" type="text" value={query} onChange={(e)=>{setQuery(e.target.value);setPage("1");loadProject()}}/>
