            ...
            <div className="flex items-center flex-col gap-4 justify-center md:px-28 px-10 py-14 dark:text-fontTextDark">
                <div className="md:w-full flex md:justify-between self-end">
                    ...
                    <div className="flex gap-3">
                        {data?.status ? (
                            <button onClick={toggleProgress} className="flex items-center bg-buttonActivated dark:bg-buttonActivatedDark hover:bg-buttonActivatedHover rounded py-2 px-4 text-fontButton dark:hover:bg-buttonActivatedHoverDark transition-colors duration-300">Em progresso</button>
                        ) : !data?.status ? (
                            <h1 className="flex items-center bg-buttonRed dark:bg-buttonRedDark hover:bg-buttonRedHover rounded py-2 px-4 text-fontButton dark:hover:bg-buttonRedHoverDark transition-colors duration-300">Finalizado</h1>
                        ) : null}
