            ...
            <div className="flex flex-col p-5 items-center justify-center">
                ...
                <div className="flex items-center justify-center mt-10 flex-col">
                    <div className="flex w-4/6 flex-wrap gap-4 items-center justify-center">
                        {modulo == 0 && (
                            <Card redirect="/foruns/java" width="72" height="65" cor="bg-purpleCard" title="Card lindo aaaaa mt texto nss aaaa preciso de mais texto pra ver oq acontece mais texto mds quanto texto nss aaaa"></Card>
                        )}
                        {modulo == 1 && (
                            <Card redirect="/foruns/outraCoisa" width="72" height="65" cor="bg-pinkCard" title="Card lindo"></Card>
                        )}
                        {modulo == 2 && (
                            <Card redirect="/foruns/outraCoisa2" width="72" height="65" cor="bg-greenCard" title="Card lindo"></Card>
                        )}
