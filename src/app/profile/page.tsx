...
export default function Profile() {
    ...
    return (
        <>
            ...
            <ProfileComponent isStudent={userData.user.student} isAdmin={isAdmin} isOnwer={userData.isOwner} name={userData.user.name} email={userData.user.email} edv={userData.user.edv} telefone={userData.user.telefone} ></ProfileComponent >
