                ...
                <div className="flex w-10/12 flex-col">
                    ...
                    <div className="md:px-14 py-5">
                        ...
                        <div className="flex mb-8 items-center md:gap-3 gap-1 w-full">
                            ...
                            <textarea value={answer} onChange={(e) => {setAnswer(e.target.value)}} name="" id="" className="border rounded-md h-15 w-11/12 resize-none p-2 text-fontTitle dark:text-fontTitleDark dark:bg-backgroundDark"></textarea>
